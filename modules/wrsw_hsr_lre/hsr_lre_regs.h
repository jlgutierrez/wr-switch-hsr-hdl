...
/* definitions for field: Link ok in reg: LRE Control Register */
#define LRE_LCR_LINK_OK_MASK                  WBGEN2_GEN_MASK(10, 2)
#define LRE_LCR_LINK_OK_SHIFT                 10
#define LRE_LCR_LINK_OK_W(value)              WBGEN2_GEN_WRITE(value, 10, 2)
#define LRE_LCR_LINK_OK_R(reg)                WBGEN2_GEN_READ(reg, 10, 2)

/* definitions for field: Clear counters in reg: LRE Control Register */
#define LRE_LCR_CLR_CNT                       WBGEN2_GEN_MASK(12, 1)
...
/* definitions for register: Ep0 bound frames */

/* definitions for register: Ep1 bound frames */

/* definitions for register: Ep0 duplicated frames */

/* definitions for register: Ep1 duplicated frames */

/* definitions for register: Ep0 sequence number */

/* definitions for register: Ep1 sequence number */
...
PACKED struct LRE_WB {
  ...
  uint32_t ACC_EP1;
  /* [0x24]: REG Ep0 bound frames */
  uint32_t BOUND_EP0;
  /* [0x28]: REG Ep1 bound frames */
  uint32_t BOUND_EP1;
  /* [0x2c]: REG Ep0 duplicated frames */
  uint32_t DUP_EP0;
  /* [0x30]: REG Ep1 duplicated frames */
  uint32_t DUP_EP1;
  /* [0x34]: REG Ep0 sequence number */
  uint32_t SEQ_EP0;
  /* [0x38]: REG Ep1 sequence number */
  uint32_t SEQ_EP1;
};
